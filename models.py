...
class User(db.Model):
    ...
    def __init__(self, breed_id, breedNotes_Id):
        self.id = self.set_id()
...
class UserSchema(ma.Schema):
    class Meta:
        fields = ['id', 'breed_id', 'breedNotes_Id']
...
class BreedNotes(db.Model):
    ...
    def __init__(self, notes, breed_id):
...
class BreedInfo(db.Model):
    ...
    def __init__(self, breed_id, breed_name, breed_group, life_span, weight, height, bred_for, temperament, reference_image_id):
        self.breed_id = breed_id
